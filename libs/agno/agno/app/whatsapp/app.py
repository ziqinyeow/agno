...
class WhatsappAPI:
    def __init__(
        ...
        if agent and team:
            raise ValueError("Both agent and team are provided. Only one can be specified.")
    ...
    def register_app_on_platform(self) -> None:
        ...
        try:
            ...
            log_debug(f"Could not create Whatsapp app: {e}")
        log_debug(f"Whatsapp app created: {self.name}, {self.app_id}")
