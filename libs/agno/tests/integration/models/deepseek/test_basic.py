...
def test_basic():
    agent = Agent(model=DeepSeek(id="deepseek-chat"), markdown=True, telemetry=False, monitoring=False)
...
def test_structured_output():
    ...
    agent = Agent(model=DeepSeek(id="deepseek-chat"), response_model=MovieScript, telemetry=False, monitoring=False)
