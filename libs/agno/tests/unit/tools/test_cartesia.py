...
class TestCartesiaTools:
    ...
    def test_init_with_api_key(self, mock_cartesia_client):
    ...
    def test_init_with_env_var(self, mock_cartesia_client):
    ...
    def test_init_override_defaults(self, mock_cartesia_client):
    ...
    def test_feature_registration(self, mock_cartesia_client):
    ...
    def test_list_voices(self, cartesia_tools, mock_cartesia_client):
    ...
    def test_list_voices_error(self, cartesia_tools, mock_cartesia_client):
    ...
    def test_text_to_speech(self, cartesia_tools, mock_cartesia_client, mock_agent):
    ...
    def test_text_to_speech_error(self, cartesia_tools, mock_cartesia_client, mock_agent):
    ...
    def test_localize_voice(self, mock_cartesia_client):
        """Test localizing a voice (assuming enabled)."""
        # Enable the specific feature for this test instance
        with patch("agno.tools.cartesia.cartesia.Cartesia") as mock_cartesia_class:
            mock_cartesia_class.return_value = mock_cartesia_client
            tools = CartesiaTools(voice_localize_enabled=True)  # Enable locally
            ...
            tools.client.voices.localize.return_value = localized_voice_data
            ...
            tools.client.voices.localize.assert_called_once_with(
                voice_id="original_voice_id",
                language="es",
                name="Localized Voice",
                description="Test Localization",
